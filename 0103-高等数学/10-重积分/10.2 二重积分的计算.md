...
![202410071006.svg](../../attachment/svg/202410071006.svg)
- 区域分别是$D_{1},D_{2},S$
- 有以下不等式
...
- 画出积分区域D
![202410071016.svg](../../attachment/svg/202410071016.svg)
...
解
- 画出积分区域D
![202410071017.svg](../../attachment/svg/202410071017.svg)
...
![202410071017_1.svg](../../attachment/svg/202410071017_1.svg)
...
- 设这两个圆柱面的方程为
  ...
  - $x^{2}+z^{2}=R^{2}$
- 画积分区域
![202410071017_2.svg](../../attachment/svg/202410071017_2.svg)
...
- 画积分区域
- ![20240515124350.png](../../attachment/png/Pasted%20image%2020240515124350.png)
...
- 画区域图
- ![20240516095212.png](../../attachment/png/Pasted%20image%2020240516095212.png)
- 设$u=y-x,v=y+x$
- $x=\frac{v-u}{2},y=\frac{u+v}{2}$
- $D':v=u,v=-u,v=2$
- ![20240516095609.png](../../attachment/png/Pasted%20image%2020240516095609.png)
