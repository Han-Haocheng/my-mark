...
- a wide range of
- The [local](.\..md#local) [government](.\..md#government) [promote](.\..md#promote v.促进；推动) a wide range of [reforms](.\..md#reforms)

### range v.变化

- *range* form A to B
- The beer [prices](.md#prices) *range* from 1 dollar to 12 dollars [par](.md#par) [bottle](.md#bottle)/[can](.md#can).
	- par adj.标准的
	- bottle n.瓶子
	- can n.罐子
...
- With the *rapid* [development](.md#development) of [technology](.md#technology).
...
- *rather*+贬义词
- The dish tastes [fairly](.md#fairly) [delicious](.md#delicious).
- The dish tastes *rather* [sour](.md#sour)

- This [passage](.\..md#passage) *rather* too [difficults](.\..md#difficult) and [juniors](.\..md#juniors) the [seniors](.\..md#seniors)
...
- = [contact](.md#contact)
- Have you *reached* your [former](.md#former) [classmate](.md#classmate)?
...
- The [research](.md#research) [proves](.md#proves) that [exercise](.md#exercise) can *reduce* your [depression](.md#depression)
- *reduce* the output
- *reduce* [cost](.md#cost)
## reduction
### reduction n.减少
...
- = mention
- The author *refers* to his  [rural](.md#rural) life in his [novel](novel.md).
	-  rural 乡村的

### refer v.查阅
- When encountering a new word int your,study you'd *better* refer to your dictionary.
- A  [vampire](.\..md#vampire) *refer* to a  [ghost](.\..md#ghost)'s blood in  [horrible](.\..md#horrible)
- The phrase pah i 
...
- It is said that one's [calligraphy](.md#calligraphy) can *reflect* his [personality](.md#personality).
	- calligraphy n.书法
	- personality n.性格
...
- regard A as B
- I *regard* [checking](.md#checking) phones as [deliberate](.md#deliberate)[murder](.md#murder) when driving.
	- deliberate adj.蓄意的
	- murder n.杀人

### regard n.注意；关注；关心

- = [attention](.md#attention) = [concern](.md#concern)
...
-  [Pedestrian](.md#Pedestrian)(Street walkers)*regularly*  [violate](.md#violate) [traffic](.md#traffic)[regulations](.md#regulations).
	- pedestrian n.行人
	- violate v.违反
	- regulation n.法规
...
- My teacher often *reminds* us that we must [abide](.md#abide) by [traffic](.md#traffic)[regulations](.md#regulations).
...
### resort v.诉诸；求助于；依靠
- resort to sth.
- The two nations *resorted* to [peace](.md#peace) talks to [settle](.md#settle) their [conflicts](.md#conflicts).
## resource
### resource n.资源
...
- One should be *responsible* for his own [mental](.md#mental) and [physical](.md#physical)[health](.md#health).

## responsibility
### responsibility n.责任

- take *responsibilities* for 为……承担责任
- We should take/[shoulder](.\..md#shoulder) *responsibility* for [building](#building)
	- prosperous adj.繁荣的
	- shoulder v.勇挑；担负
- Who are not [mentioned](.md#mentioned) as being *responsible* for the road [accidents](.md#accidents)?
...
### result n.结果；后果
- = consequence
- One should be [responsible](.\..md#responsible adj.负责任的；有责任的) *results* of the [event](.\..md#event)
...
- The driver's [carelessness](.\..md#carelessness) *result* in the road [accident](.\..md#accident)
...
- A [recent](.md#recent) [research](.md#research)*reveals* that rope jumping is good for one's health.
- study/#research](.md#research)/[survey](.md#survey)/[questionnaire](.md#questionnaire)/[experiment](.md#experiment)/test *reveal*/[indicate](.md#indicate)/show/[prove](.md#prove)/[demonstrate](.md#demonstrate) that

- *reveal* the [mystery](.md#mystery) of the [universe](.md#universe).
...
- Smoking can [increase](.md#increase) the *risk* of [developing](.md#developing) heart [disease](.md#disease).
	- disease n.病

### risk v.使……冒风险；面临风险

- *risk* doing sth
- The [soldier](.\..md#soldier) *risk* his life to [save](.\..md#save)
	- drowning adj.溺水的
...
- [Previewing](.\..md#Previewing) and [reviewing](.\..md#reviewing) [lessons](.\..md#lessons) play a *role* in study [results](.\..md#results)

## row

### row n.一行；一排；一列；划船

- a *row* of [tents](.md#tents) [along](.md#along) the river [banks](.md#banks).
	- tents n.帐篷
- in a row 连续地
- The [thief](.md#thief) [stole](.md#stole) the things in a row.
	- 
### row v.划船
