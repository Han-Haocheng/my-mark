...
- 误差 $$
\begin{align}
r_{n}= & \frac{1}{n!}+\frac{1}{(n+1)!}+\frac{1}{(n+2)!}+\dots \\
 = & \frac{1}{n!}\left( 1+ \frac{1}{n+1} +\frac{1}{(n+1)(n+2)}+ \frac{1}{(n+1)(n+2)(n+3)}+\dots \right) \\
< & \frac{1}{n!}\left( 1+ \frac{1}{n}+ \frac{1}{n^{2}} +\frac{1}{n^{3}}+\dots \right) \\
= & \frac{1}{n!} \frac{1}{1- \frac{1}{n}} \\
= & \frac{1}{(n-1)(n-1)!}
\end{align}
